    ...
    create(){
        ...
        this.add.container(400,450,[btnCont,textCont])
            ...
            .on('pointerup',() => {
                btnCont.setFrame(0);
                textCont.y = 0;
                this.scene.start(this.nextKey,{score:this.score,lifes:this.lifes,time:this.tempoFinal,final:pontuacao,player:this.playerKey,cpu:this.cpuKey,headFile:this.headKey,collisionFile:this.collisionKey,theme:"desert"});
                this.scene.stop();
            });
        //endregion
    }
